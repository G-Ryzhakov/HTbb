...
BMS_ARGS = {"d_x": 7, "d_y": 7, "n": 8, "r_x": 10, "r_y": 10}
...
OPTI_ARGS = {"m": 1.0e4, "seed": 0, "with_cache": False}
OPTI_OPTS_OUR = {}
...
def _args_build():
    ...
    parser.add_argument(
        "--with_calc", action="store_true", help="Do we perform computations"
    )
    parser.add_argument(
        "--with_no_calc",
        action="store_false",
    ...
    parser.add_argument("--bmseed", type=int, default=42)
    parser.add_argument(
        "--gpu",
        type=str,
        default=None,
